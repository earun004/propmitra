...
export const ROUTES: RouteInfo[] = [
  { 
    ...
    },
    {
      ...
      children: [
        { path: '/user-form', title: 'Site Visit Request', icon: 'view_list', class: '' },
      ]
    },    
  ...
  { 
    ...
    },
    {
      ...
      children: [
        ...
        { path: '/customers', title: 'Active / Inactive Users', icon: 'person_add_disabled', class: '' },
      ]
    },
    {
...
export class SidebarComponent implements OnInit {
  ...
  ngOnInit() {
    if(localStorage.getItem('has_role') === "ROLE_ADMIN") {
      this.menuItems = ADMIN_ROUTES.filter(menuItem => menuItem);
    } else if(localStorage.getItem('has_role') === "ROLE_USER") {
